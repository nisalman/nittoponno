...
@section('title', 'Update Coordinator')
...
@section('content')
    ...
    <div class="col-sm-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Update Coordinator</div>

            <div class="panel-body">

                <form class="form-horizontal" method="post" action="/admin/moderator/update"
                        ...
                        <div class="col-lg-10">
                            <select name="district_id" class="form-control m-b">
                                ...
                                @foreach ($districts  as $value)
                                    <option value="{{ $value->district_id}}" @if($value->district_id==$result->district_id) @endif >{{$value->en_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
