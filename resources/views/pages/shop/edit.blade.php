...
@section('content')
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default" ng-controller="supplierController">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" action="/admin/shop/update"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="hidden" class="form-control" name="shop_id" value="{{$shop->shop_id}}">
                                ...
                                <div class="col-lg-9">
                                    <select name="service_type" class="form-control m-b">
                                        ...
                                        @foreach (getServiceType() as $key => $value)
                                            <option value="{{ $key}}"
                                                    @if($shop->service_type==$key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" class="form-control" name="per_day_capacity"
                                           value="{{$shop->per_day_capacity}}" required>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="checkbox checkbox-success">
                                        <input id="kk" name="is_serve_in_depth"
                                               value="1" type="checkbox" @if($shop->is_serve_in_depth)checked @endif >
                                        <label for="k">
                                            I only serve here
                                        </label>
                                    </div>
    ...
    <script>
        ...
        app.controller('supplierController', function ($scope, $http) {
            $scope.coverage_depth = "<?php echo $shop->coverage_depth?>";
            ...
            $scope.coverageDepth($scope.coverage_depth);
            ...
            $scope.division_id = "<?php echo $shop->division_id?>";
            if ($scope.division_id) {
                console.log("init");
                $scope.changeDivision(<?php echo $shop->division_id?>);
            }


            $scope.district_id = "<?php echo $shop->district_id?>";
            if ($scope.district_id) {
                console.log("init");
                $scope.changeDistrict(<?php echo $shop->district_id?>);
            }


            $scope.upazila_id = "<?php echo $shop->upazila_id?>";
            if ($scope.upazila_id) {
                console.log("init");
                $scope.changeUpazila(<?php echo $shop->upazila_id?>);
            }


            $scope.union_id = "<?php echo $shop->union_id?>";
