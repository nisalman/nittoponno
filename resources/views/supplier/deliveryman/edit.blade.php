...
@section('title', 'Upload Deliveryman')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="ibox ">
                    <h4>Delivery Man Info</h4>
                    <div class="ibox-content" ng-controller="supplierController">

                        <form class="form-horizontal" method="post" action="/admin/deliveryman/update"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="hidden" class="form-control" name="_token"
                                                   value="{{csrf_token()}}">
                                            <input type="hidden" class="form-control" name="id" value="{{$result->delivery_man_id}}">
